...
@Entity
public class FreeLookCancellationNotes {
    ...
    public FreeLookCancellationNotes() {
    }

    public FreeLookCancellationNotes(Long freeLookId, Long policyId, Long serviceId, String notesText) {
