...
public class PolicyLevelMergerController {
	...
	@GetMapping("/existingpolicies/{policyNumber}")
	public ExistingPolicy getExistingPolicyByPolicyNumber(@PathVariable("policyNumber") String policyNumber) {
		return policyLevelMergerControllerService.getExistingPolicyByPolicyNumber(policyNumber);
	}
